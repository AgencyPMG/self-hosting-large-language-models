...
def _parse_args(args: ArgsType=None) -> argparse.Namespace:
...
def _download_model(model_name: str, output_path: pathlib.Path):
    """
...
def main(args: ArgsType=None):
    ...
    _download_model(args.model_name, args.output_path)
